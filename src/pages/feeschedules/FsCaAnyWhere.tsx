import {
  ...
  export default function FsCaAnyWherePage() {
    ...
    const columns: GridColDef[] = [
      ...
      { field: 'nameovstos', headerName: 'สถานะ', width: 110 },
    ...
    const onSubmit = async () => {
      ...
      try {
        const response = await axios.post(`${apiHiUrl}/fs/caanywhere`, {
          startDate,
          endDate,
        })
        ...
        <Box sx={{ width: '100%', height: '500px', typography: 'body1' }}>
          <TabContext value={valueTab}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              ...
              >
                <Tab label="Case CA Anywhere" value="1" />
