...
export default function FsHerbPage() {
  ...
  const columns: GridColDef[] = [
    ...
    { field: 'nameprscdt', headerName: 'ชื่อยา', width: 280 },
  ...
  const onSubmit = async () => {
    ...
    try {
      const response = await axios.post(`${apiHiUrl}/fs/herb`, {
        startDate,
        endDate,
      })
