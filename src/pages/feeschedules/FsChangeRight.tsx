import {
  ...
  export default function FsChangeRightPage() {
    ...
    const columns: GridColDef[] = [
      ...
      { field: 'dateright', headerName: 'date_right', width: 110 },
      { field: 'dateserv', headerName: 'วันที่', width: 110 },
      { field: 'timeserv', headerName: 'เวลา', width: 110 },
      { field: 'cln', headerName: 'clinic code', width: 110 },
      ...
      { field: 'icd10', headerName: 'icd10', width: 250 },
      { field: 'icd9cm', headerName: 'icd9cm', width: 280 },
    ...
    const onSubmit = async () => {
      ...
      try {
        const response = await axios.post(`${apiHiUrl}/fs/changeright`, {
          startDate,
          endDate,
        })
        ...
        <Box sx={{ width: '100%', height: '500px', typography: 'body1' }}>
          <TabContext value={valueTab}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              ...
              >
                <Tab label="Case UCS เปลี่ยนสิทธิ์ทันที" value="1" />
