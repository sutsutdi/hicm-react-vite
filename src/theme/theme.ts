...
import Prompt from '../assets/fonts/Prompt/Prompt-Regular.ttf'
...
export const theme = createTheme({
  ...
  components: {
    ...
    MuiCssBaseline: {
      styleOverrides: {
        '@global': {
            '@font-face': {
              fontFamily: 'Prompt', // Specify the font-family name
              fontStyle: 'normal',
              fontWeight: '400',
              src: `local('Prompt Regular'), local('Prompt-Regular')`, // Provide the font source URL
              unicodeRange:
                'U+0-10FFFF',
            },
          },
  ...
  typography: {
    fontFamily:
      'Prompt ,"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
    h1: {
      fontWeight: 700,
      fontSize: 35,
    },
